      ...
      <main className="relative z-10">
                ...
                return (
                  ...
                  >
                    <div className="flex flex-col items-center text-center">
                      <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-primary to-primary-dark flex items-center justify-center mb-5 group-hover:scale-110 transition-transform">
        ...
        <section id="reports" className="py-24 px-4 relative">
          ...
          <div className="relative max-w-5xl mx-auto">
            ...
            <div className="card rounded-2xl p-10 shadow-md">
              <div className="grid md:grid-cols-3 gap-8 text-center">
                {[
                  ...
                  <div key={report.label} className="group">
                    <h3 className="text-lg font-semibold text-text-primary mb-2 group-hover:text-primary transition-colors">{report.label}</h3>
                    <p className="text-sm text-text-secondary leading-relaxed">{report.desc}</p>
                  </div>
                ))}
              </div>
            </div>
