  ...
  return (
    <div className="min-h-screen bg-surface overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="orb" style={{ width: '300px', height: '300px', top: '50%', left: '66%', animationDelay: '-14s', background: 'radial-gradient(circle, rgba(99, 102, 241, 0.15), transparent 70%)' }} />
      </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                return (
                  ...
                  >
                    <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-primary to-primary-dark flex items-center justify-center mx-auto mb-5 group-hover:scale-110 transition-transform">
                      <Icon className="w-7 h-7 text-white" />
                    </div>
