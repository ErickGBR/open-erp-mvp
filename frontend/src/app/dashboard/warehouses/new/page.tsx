...
export default function NewWarehousePage() {
  ...
  return (
    <div className="max-w-lg mx-auto">
      <h1 className="text-xl font-bold text-white mb-6">Nuevo Almacén</h1>
      <form onSubmit={handleSubmit} className="glass-card rounded-xl p-6 space-y-4">
        <div>
          <label className="text-xs text-slate-400 mb-1 block">Nombre del Almacén *</label>
        ...
        <div>
          <label className="text-xs text-slate-400 mb-1 block">Localidad</label>
